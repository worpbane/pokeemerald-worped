...
#define BW_SUMMARY_MON_IDLE_ANIMS_FRAMES            1000     // number of frames between each idle anim IF BW_SUMMARY_MON_IDLE_ANIMS is true.
...
/* Info for users //WORP: Added from pokeemerald-expansion fork.
