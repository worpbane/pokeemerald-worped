...
const u32 gInterfaceTypeIconsMenu_Gfx[] = INCBIN_U32("graphics/interface/typeIconsMenu.4bpp.lz");
...
// Pokedex HGSS
const u16 gPokedexPlusHGSS_Default_Pal[]             					= INCBIN_U16("graphics/pokedex/w/wPokeDex_palette_hoenn.gbapal");
const u16 gPokedexPlusHGSS_National_Pal[]            					= INCBIN_U16("graphics/pokedex/w/wPokeDex_palette_national.gbapal");
const u16 gPokedexPlusHGSS_MenuSearch_Pal[]          					= INCBIN_U16("graphics/pokedex/w/wPokeDex_search.gbapal");
const u16 gPokedexPlusHGSS_SearchResults_Pal[]       					= INCBIN_U16("graphics/pokedex/w/wPokeDex_palette_search.gbapal");
const u32 gPokedexPlusHGSS_MenuList_Gfx[]        						= INCBIN_U32("graphics/pokedex/w/wPokeDexTiles.4bpp.lz");
const u32 gPokedexPlusHGSS_Interface_Gfx[]       						= INCBIN_U32("graphics/pokedex/w/wPokeDexInterface.4bpp.lz");
const u32 gPokedexPlusHGSS_Menu_Gfx[]      								= INCBIN_U32("graphics/pokedex/w/wPokeDexTiles.4bpp.lz");
const u32 gPokedexPlusHGSS_MenuSearch_Gfx[]          					= INCBIN_U32("graphics/pokedex/w/wPokeDexTilesSearch.4bpp.lz");
const u32 gPokedexPlusHGSS_ScreenSelectBarSubmenu_Tilemap[]             = INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_area.bin.lz");
const u32 gPokedexPlusHGSS_ScreenSelectBarSubmenu_Tilemap_Clear[]  	    = INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_area_blank.bin.lz");
const u32 gPokedexPlusHGSS_ScreenList_Tilemap[]          				= INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_list.bin.lz");
const u32 gPokedexPlusHGSS_ScreenListUnderlay_Tilemap[] 				= INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_list_underlay.bin.lz");
const u32 gPokedexPlusHGSS_ScreenInfo_Tilemap[]          				= INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_info.bin.lz");
const u32 gPokedexPlusHGSS_ScreenStats_Tilemap[]         				= INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_stats.bin.lz");
const u32 gPokedexPlusHGSS_ScreenEvolution_Tilemap[]     				= INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_evo.bin.lz");
const u32 gPokedexPlusHGSS_ScreenCry_Tilemap[]           				= INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_cry.bin.lz");
const u32 gPokedexPlusHGSS_ScreenSize_Tilemap[]          				= INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_size.bin.lz");
const u32 gPokedexPlusHGSS_ScreenSearchHoenn_Tilemap[]   				= INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_search_hoenn.bin.lz");
const u32 gPokedexPlusHGSS_ScreenSearchNational_Tilemap[] 				= INCBIN_U32("graphics/pokedex/w/wPokeDex_tilemap_search_national.bin.lz");
