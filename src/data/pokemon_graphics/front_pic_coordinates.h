...
const struct MonCoords gMonFrontPicCoords[] =
{
	...
	[SPECIES_OINKOLOGNEM]       		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 7 },
	[SPECIES_OINKOLOGNEF]       		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 7 },
	[SPECIES_STUFFUL]       			   = { .size = MON_COORDS_SIZE(56, 64), .y_offset = 12 },
	[SPECIES_BEWEAR]       				   = { .size = MON_COORDS_SIZE(56, 64), .y_offset = 2 },
