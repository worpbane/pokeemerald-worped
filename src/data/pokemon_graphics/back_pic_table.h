const struct CompressedSpriteSheet gMonBackPicTable[] =
{
	...
	SPECIES_SPRITE(OINKOLOGNEM, gMonBackPic_OinkologneM),
	SPECIES_SPRITE(OINKOLOGNEF, gMonBackPic_OinkologneF),
	...
	SPECIES_SPRITE(WOOPERPALDEAN, gMonBackPic_WooperPaldean),
