const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
	...
	SPECIES_SPRITE(OINKOLOGNEM, gMonFrontPic_OinkologneM),
	SPECIES_SPRITE(OINKOLOGNEF, gMonFrontPic_OinkologneF),
	...
	SPECIES_SPRITE(WOOPERPALDEAN, gMonFrontPic_WooperPaldean),
