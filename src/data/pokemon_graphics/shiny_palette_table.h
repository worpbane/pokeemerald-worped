const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
	...
	SPECIES_SHINY_PAL(OINKOLOGNEM, gMonShinyPalette_OinkologneM),
	SPECIES_SHINY_PAL(OINKOLOGNEF, gMonShinyPalette_OinkologneF),
	...
	SPECIES_SHINY_PAL(WOOPERPALDEAN, gMonShinyPalette_WooperPaldean),
