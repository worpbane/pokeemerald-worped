const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	//WorpAdditions
	[SPECIES_LECHONK]   = {{EVO_LEVEL_MALE, 18, SPECIES_OINKOLOGNEM},
						  {EVO_LEVEL_FEMALE, 18, SPECIES_OINKOLOGNEF}},
	...
	[SPECIES_MINCCINO]  = {{EVO_ITEM_HOLD, ITEM_MOON_STONE, SPECIES_CINCCINO}},
	[SPECIES_WOOPERPALDEAN] = {{EVO_LEVEL, 20, SPECIES_CLODSIRE}},
