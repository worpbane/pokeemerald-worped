...
static const u16 sMayMugshot_Pal[] = INCBIN_U16("graphics/ui_main_menu/may_front_pic.gbapal");
static const u32 sMayMugshot_Gfx[] = INCBIN_U32("graphics/ui_main_menu/may_front_pic.4bpp.lz");
