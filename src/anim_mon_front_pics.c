...
const u32 gMonFrontPic_Lechonk[] = INCBIN_U32("graphics/pokemon/lechonk/anim_front.4bpp.lz");
const u32 gMonFrontPic_OinkologneM[] = INCBIN_U32("graphics/pokemon/oinkologne/anim_front.4bpp.lz");
const u32 gMonFrontPic_OinkologneF[] = INCBIN_U32("graphics/pokemon/oinkologne/f/anim_front.4bpp.lz");
